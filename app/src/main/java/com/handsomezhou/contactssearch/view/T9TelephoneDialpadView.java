...
public class T9TelephoneDialpadView extends LinearLayout implements
    ...
    public void setInflater_ViwGroup(Button mTelephoneDialCloseBtn, Button mDialDeleteBtn, EditText mT9InputEt) {
        this.mTelephoneDialCloseBtn = mTelephoneDialCloseBtn;
        this.mDialDeleteBtn = mDialDeleteBtn;
...
//        initListener();
    ...
    private void initView() {
        ...
        mDialpadView = inflater.inflate(R.layout.t9_telephone_dialpad_layout, this);
//        View mDialpadView2 = inflater2.inflate(R.layout.fragment_t9_search, container2);
//
//        mTelephoneDialCloseBtn = (Button) mDialpadView2.findViewById(R.id.telephone_dial_close_btn);
//        mDialDeleteBtn = (Button) mDialpadView2.findViewById(R.id.dial_delete_btn);
//        mT9InputEt = (EditText) mDialpadView2.findViewById(R.id.dial_input_edit_text);
